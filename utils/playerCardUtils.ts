...
export const CARD_THEMES: Record<CardRarity, any> = {
    icon: {
        id: 'icon',
        name: 'Supreme Diamond Gold Icon',
        isLightCard: true,
        cardBg: ['#FFFFFF', '#FAF5EB', '#F2E8D5', '#E0F2FE'],
        accentGlow: '#38BDF8',
        borderGradient: ['#FFFFFF', '#E0F2FE', '#FDE047', '#38BDF8', '#FEF08A', '#0284C7', '#FFFFFF'],
        textPrimary: '#0F172A',
        textGold: '#B45309',
        foilOverlay: 'rgba(56, 189, 248, 0.15)',
