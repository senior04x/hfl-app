...
REM 2. Expo accountga login qilish
...
REM 3. EAS build konfiguratsiya qilish
...
REM 4. app.json faylini tekshirish va yangilash
...
REM 5. eas.json faylini tekshirish va preview profili qo'shish
...
REM 6. Android APK build qilish
...
REM 7. Build tugagach, APK yuklab olish linkini ko'rsatish
